            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <form id="setting-form" method="post" enctype="multipart/form-data"
                        action="<?php echo site_url('home/insert_toko');?>">
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="idKonsumen" class="form-control" id="idKonsumen"
                                    value="<?php echo $id ?>">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        <div class="custom-file">
                                            <input type="file" name="logo_toko" class="custom-file-input"
                                                id="site-logo">
