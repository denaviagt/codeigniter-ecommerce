...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="<?php echo base_url('assets/admin/node_modules/bootstrap-social/bootstrap-social.css')?>">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="<?php echo base_url('assets/admin/assets/img/stisla-fill.svg')?>" alt="logo"
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo site_url('login/aksi_login_member');?>"
