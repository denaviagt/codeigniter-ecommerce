...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url('assets/admin/node_modules/summernote/dist/summernote-bs4.css') ?>">
    <link rel="stylesheet"
        href="<?php echo base_url('assets/admin/node_modules/owl.carousel/dist/assets/owl.carousel.min.css') ?>">
    <link rel="stylesheet"
        href="<?php echo base_url('assets/admin/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css') ?>">
...
<body>
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('assets/admin/assets/img/products/product-3-50.png') ?>"
                                        alt="product">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('assets/admin/assets/img/products/product-2-50.png') ?>"
                                        alt="product">
                                    Drone X2 New Gen-7
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30"
                                        src="<?php echo base_url('assets/admin/assets/img/products/product-1-50.png') ?>"
                                        alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('assets/admin/assets/img/avatar/avatar-1.png') ?>"
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('assets/admin/assets/img/avatar/avatar-2.png') ?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Dedik Sugiharto</b>
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('assets/admin/assets/img/avatar/avatar-3.png') ?>"
                                            class="rounded-circle">
                                        <div class="is-online"></div>
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('assets/admin/assets/img/avatar/avatar-4.png') ?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image"
                                            src="<?php echo base_url('assets/admin/assets/img/avatar/avatar-5.png') ?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Alfa Zulkarnain</b>
    ...
    <script src="<?php echo base_url('assets/admin/node_modules/owl.carousel/dist/owl.carousel.min.js')?>"></script>
