        ...
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <form class="form-inline ml-auto">
                    ...
                    <div class="search-element">
                        <select data-width="150" class="form-control">
                            ...
                            <option class="form-control"><?= $kat->namaKategori; ?></option>
                            <?php } ?>
                        </select>
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li><a href="<?php echo site_url('member/keranjang');?>"><i class="far fa-bell"></i></a>

                    </li>

                </ul>
                <?php if($this->session->userdata('username')){ ?>
                <a href="<?php echo site_url('home/menu_member');?>" class="btn btn-outline-light">Menu Member</a>
                &nbsp; &nbsp; &nbsp;
                <a href="<?= site_url('home/logout');?>" class="btn btn-outline-light">Logout</a>
                <?php } else {  ?>
                <a href="<?= site_url('home/login');?>" class="btn btn-outline-light">Masuk</a>
                &nbsp; &nbsp; &nbsp;
                <a href="<?= site_url('home/register');?>" class="btn btn-outline-light">Daftar</a>
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"><span><?php echo $item->namaKategori; ?></span></a>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
